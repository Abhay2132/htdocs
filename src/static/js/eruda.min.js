			...
			(function (t, r, i) {
				...
				var o,
					...
					N = (O.isBrowser =
						...
						"object" ===
							("undefined" == typeof document ? "undefined" : k()(document)) &&
						9 === document.nodeType),
					D = (O.noop = function () {}),
					...
					W = (O.detectOs = function (t) {
						if (
							((t = (t = t || (N ? navigator.userAgent : "")).toLowerCase()),
							e("windows phone"))
						)
					...
					et = (O.getObjType = function (t) {
						return t.constructor && t.constructor.name
							? t.constructor.name
							: tt({}.toString.call(t).replace(/(\[object )|]/g, ""));
					}),
					...
					Ht = (O.lpad = function (t, e, n) {
						var r = (t = q(t)).length;
						return (
							(n = n || " "), r < e && (t = (Bt(n, e - r) + t).slice(-e)), t
						);
					}),
							...
							var h = u ? "getUTC" : "get",
								...
								w = {
									...
									Z: l
										...
										: u
										? "UTC"
										: (q(a).match(r) || [""]).pop().replace(o, ""),
									o:
										(y > 0 ? "-" : "+") +
										e(
											100 * Math.floor(Math.abs(y) / 60) + (Math.abs(y) % 60),
											4
										),
									S: ["th", "st", "nd", "rd"][
					...
					Ut = (O.ltrim =
						...
						function (t, e) {
							...
							for (
								var n, r, i = 0, o = t.length, a = e.length, s = !0;
								s && i < o;
					...
					Xt = (O.detectBrowser = (function (t) {
						...
						function i(t, e) {
							var n = t.indexOf(e);
							if (n > -1)
								return Jt(t.substring(n + e.length, t.indexOf(".", n)));
						}
						return t;
					})({})),
					Yt = (O.nextTick = (function (t) {
						...
						return "object" === (void 0 === r ? "undefined" : k()(r)) &&
							r.nextTick
							? r.nextTick
							: "function" == typeof i
							? function (t) {
					...
					le = (O.highlight = (function (t) {
						t = function (r) {
								...
								e.language &&
									(r = r.replace(e.re, function (n, r) {
										return (
											...
											n.replace(r, "___subtmpl" + (a - 1) + "___")
										);
									}));
							}),
								dt(i, function (t, e) {
							...
							return (
								...
								dt(i, function (t, e) {
									r = r
										.replace(new RegExp("___end" + e + "___", "g"), "</span>")
										.replace(
					...
					fe = (O.map = function (t, e, n) {
						e = re(e, n);
						for (
							var r = !_t(t) && T(t), i = (r || t).length, o = Array(i), a = 0;
							a < i;
							a++
						) {
							var s = r ? r[a] : a;
									...
									(function (t) {
										...
										(t.style.display = (function (t) {
											...
											e[t] ||
												...
												(r = getComputedStyle(n, "").getPropertyValue(
													"display"
												)),
								...
								for (; a !== this; a = a.parentNode || this) {
									for (r = [], o = 0; o < u; o++)
										void 0 === r[(n = (i = e[o]).selector + " ")] &&
											(r[n] = yt(this.querySelectorAll(n), a)),
											r[n] && r.push(i);
									r.length && s.push({ el: a, handlers: r });
								}
							return (
								u < e.length && s.push({ el: this, handlers: e.slice(u) }), s
							);
						}
						return (t = {
								...
								if (i && i[e])
									for (var o, a = i[e], s = a.length; s--; )
										(o = a[s]),
											(n && o.selector != n) ||
												o.handler != r ||
												(a.splice(s, 1), o.selector && a.delegateCount--);
							},
							Event: de({
								className: "Event",
								initialize: function (t) {
							...
							S(a) || ((a = {})[t] = i),
								(function (t) {
									dt(t, function (t, n) {
										...
										(i = e.createElement("meta")).setAttribute("name", n),
					...
					Ne = (O.partial = G(function (t, e) {
						return function () {
							var n = [];
							return (
								(n = (n = n.concat(e)).concat(_e(arguments))), t.apply(this, n)
							);
						};
					})),
					De = (O.once = Ne(R, 2)),
					...
					Ke = (O.raf = (function (t) {
						...
						if (N) {
							...
							for (
								var i = ["ms", "moz", "webkit", "o"], o = 0, a = i.length;
								o < a && !e;
								o++
							)
					...
					Ve = (O.rtrim = (function (t) {
						...
						return function (t, n) {
							...
							for (
								var r, i, o = t.length - 1, a = n.length, s = !0;
								s && o >= 0;
							...
							},
							{
								parse: function (t) {
									...
									if (
										...
										var f = u.lastIndexOf("@");
										-1 !== f &&
											((i.auth = decodeURIComponent(u.slice(0, f))),
											(u = u.slice(f + 1))),
											(i.hostname = u);
										var _ = u.match(n);
										_ &&
											(":" !== (_ = _[0]) && (i.port = _.substr(1)),
											(i.hostname = u.substr(0, u.length - _.length)));
									}
									var d = o.indexOf("#");
								...
								stringify: function (t) {
									var e =
										...
										t.pathname;
									return (
										wt(t.query) || (e += "?" + Ye.stringify(t.query)),
										t.hash && (e += t.hash),
										e
									);
								},
					...
					cn = (O.stringifyAll = (function (t) {
						function e(e, r, i, o) {
							...
							return (
								dt(r, function (e) {
									...
									a.push("".concat(n(e), ":").concat(t(r, o))),
										u &&
											a.push(
												"".concat(n("get " + q(e)), ":").concat(t(s.get, o))
											),
										l &&
											a.push(
												"".concat(n("set " + q(e)), ":").concat(t(s.set, o))
											);
								}),
								'"'.concat(e, '":{') + a.join(",") + "}"
							);
						...
						t = function (n) {
							...
							if ("String" === E) j = r(n);
								...
								(j = q(n)),
									Q(j, "Infinity") &&
										(j = '{"value":"'.concat(j, '","type":"Number"}'));
							else if ("NaN" === E) j = '{"value":"NaN","type":"Number"}';
							else if ("Boolean" === E) j = n ? "true" : "false";
							else if ("Null" === E) j = "null";
							else if ("Undefined" === E) j = '{"type":"Undefined"}';
							else if ("Symbol" === E) {
								var A = "Symbol";
								try {
									A = q(n);
								...
								if (
									(N
										? ((C = N.id), P.push('"reference":'.concat(C)))
										: ((C = v.set(n)), P.push('"id":'.concat(C))),
									P.push('"type":"'.concat(E, '"')),
									Q(E, "Function")
										? P.push('"value":'.concat(r(ln(n))))
										: "RegExp" === E && P.push('"value":'.concat(r(n))),
									!N)
								) {
									var D = T(n);
									if ((D.length && P.push(e("enumerable", D, a || n, S)), m)) {
										var R = oe(se(n, { prototype: !1, unenumerable: !0 }), D);
									...
									var I = ht(n);
									if (I && !yt($, I)) {
										var L = '"proto":'.concat(t(I, ce(S, { self: a || n })));
										P.push(L);
									}
								}
								j += P.join(",") + "}";
					...
					return (function (t) {
							...
							var a = (function (t) {
								...
								return (
									...
									(e.prototype.trigger = function (t, e) {
										this.emit(
											"message",
											JSON.stringify({ method: t, params: e })
										);
									}),
									e
								);
							...
							var r = n(27),
								...
								u = ((e = function (t, e) {
									...
									var c = function () {
										var t = i(arguments);
										return (
											(this.initialize && this.initialize.apply(this, t)) ||
											this
										);
									};
									if (!s)
							...
							function $(t, e) {
								...
								return "undefined" === c
									...
									: ("function" === c
											...
											: "array" === h
											? ((l.className = "Array"),
											  (l.description = "Array(" + t.length + ")"))
											: "regexp" === h
											? ((l.className = "RegExp"),
											  (l.description = o.default(t)))
											: "error" === h
											? ((l.className = t.name), (l.description = t.stack))
									  ...
									  a &&
											(l.preview = r(
												...
												(function (t, e) {
													...
													return { overflow: n, properties: r };
												})(t, u)
											)),
									  (l.objectId = O(t, u)),
									  l);
								...
								(e.getProperties = function (t) {
									for (
										var e = t.accessorPropertiesOnly,
											...
											i = t.generatePreview,
											a = [],
											s = { prototype: !r, unenumerable: !0, symbol: !e },
											l = y.get(n),
											c = x.get(n),
											h = d.default(l, s),
											p = g.default(l),
										...
										var O = { name: o.default(w), isOwn: b.default(c, w) },
											j = Object.getOwnPropertyDescriptor(l, w);
										if (
											(!j && p && (j = Object.getOwnPropertyDescriptor(p, w)),
											j)
										) {
										...
										!O.isOwn && O.get && (S = !1),
											S &&
												(m.default(w)
													? ((O.symbol = $(w)),
													  (O.value = { type: "undefined" }))
													: (O.value = $(k, { generatePreview: i }))),
						...
						function (t, e, n) {
							...
							function f(t, e) {
								...
								if (
									(t.parentNode && (o.parentId = p(t.parentNode)), t.attributes)
								) {
									var s = [];
							...
							function v(t) {
								...
								return !(
									3 === t.nodeType && "" === s.default(t.nodeValue || "")
								);
							}
						...
						function (t, e) {
							(e = function (t, e, n) {
								...
								return n || t % 1 || e % 1
									? Math.min(
											t +
												r * (e - t + parseFloat("1e-" + ((r + "").length - 1))),
											e
									  )
						...
						function (t, e, n) {
							...
							var i = r(n(1)),
								...
								c = {
									copy: function (t) {
										i.default(t) || (t = JSON.stringify(t, null, 2)),
											o.default(t);
									},
									$: function (t) {
										...
										return (
											...
											t
												? i(t)
													? s.find(t)
													: void (
															t.nodeType && ((this[0] = t), (this.length = 1))
													  )
												: this
										);
									},
						...
						function (t, e, n) {
									...
									return (
										...
										(e.prototype.handleDone = function () {
											...
											("text" !== u.type &&
												...
												"json" !== u.subType)
												? (("" !== o && "text" !== o) || (a = i.responseText),
												  "json" === o && (a = JSON.stringify(i.response)),
												  s())
												: ((t = i.response),
												  (e = function (t, e) {
														e && (a = e), s();
											...
											t.then(function (t) {
												...
												return (
													t.text().then(function (r) {
														...
														c.default(e.reqHeaders) ||
															(i.reqHeaders = e.reqHeaders),
															e.emit("done", e.id, i);
													}),
													t
												);
							...
							function O(t) {
								return (
									(k.href = t),
									k.protocol + "//" + k.host + k.pathname + k.search + k.hash
								);
							}
							function $(t) {
								var e = u.default(t.split("/"));
								return (
									e.indexOf("?") > -1 && (e = h.default(e.split("?")[0])),
									"" === e && (e = new l.default(t).hostname),
									e
								);
							}
							function j(t) {
								if (!t) return { type: "unknown", subType: "unknown" };
						...
						function (t, e, n) {
							...
							Object.defineProperty(e, "__esModule", { value: !0 }),
								(e.setOuterHTML =
									...
									e.setInspectedNode =
									e.setAttributeValue =
									e.setAttributesAsText =
									e.resolveNode =
									e.requestNode =
									e.requestChildNodes =
									e.removeNode =
									e.pushNodesByBackendIdsToFrontend =
									e.discardSearchResults =
									e.pushNodesToFrontend =
									e.getSearchResults =
									e.performSearch =
									e.moveTo =
									e.getOuterHTML =
									...
									e.enable =
									e.copyTo =
									e.collectClassNamesFromSubtree =
										void 0);
							var s = a(n(10)),
								u = o(n(26)),
								l = n(26),
							...
							(e.collectClassNamesFromSubtree = function (t) {
								...
								(e.getOuterHTML = function (t) {
									return { outerHTML: l.getNode(t.nodeId).outerHTML };
								}),
								(e.moveTo = function (t) {
									var e = t.nodeId,
										n = t.targetNodeId,
							...
							(e.performSearch = function (t) {
								...
								var r = y.createId();
								return j.set(r, n), { searchId: r, resultCount: n.length };
							}),
							...
							function A(t, e) {
								for (
									var n = u.filterNodes(t.childNodes), r = 0, i = n.length;
									r < i;
									r++
								) {
									var o = n[r];
							...
							(e.setInspectedNode = function (t) {
								...
								for (var n = 0; n < 5; n++) m.setGlobal("$" + n, E[n]);
							}),
								...
								h.default.on("childList", function (t, e, n) {
									...
									function f() {
										s.default.trigger("DOM.childNodeCountUpdated", {
											childNodeCount: u.wrap(t, { depth: 0 }).childNodeCount,
											nodeId: r,
										});
									}
								}),
								...
								u = (function (t) {
									...
									return (
										...
										(e.prototype.handleMutation = function (t) {
											"attributes" === t.type
												? this.emit("attributes", t.target, t.attributeName)
												: "childList" === t.type
												? this.emit(
														"childList",
														t.target,
												...
												: "characterData" === t.type &&
												  this.emit("characterData", t.target);
										}),
										e
									);
								})(a.default);
						...
						function (t, e, n) {
							...
							(e = function () {
								for (
									var t = r(arguments), e = [], n = 0, i = t.length;
									n < i;
									n++
								)
									e = e.concat(r(t[n]));
						...
						function (t, e, n) {
							...
							(e.enable = l.default(function () {
										...
										n.on("send", function (t, e) {
											...
											n.on("done", function (t, e) {
												p.default.trigger("Network.responseReceived", {
													requestId: t,
													type: "Fetch",
													response: { status: e.status, headers: e.resHeaders },
													timestamp: e.time / 1e3,
												}),
													f.set(t, e.resTxt),
													p.default.trigger("Network.loadingFinished", {
								...
								(e.getResponseBody = function (t) {
									return { base64Encoded: !1, body: f.get(t.requestId) };
								});
						},
						function (t, e, n) {
							var r = n(0),
								...
								p = (function () {
									...
									return (
										...
										(t.prototype.sendMessage = function (t, e) {
											...
											return (
												this.sendRawMessage(
													JSON.stringify({ id: r, method: t, params: e })
												),
						...
						function (t, e) {
							(e = function (t, e, n) {
								var r = t.length;
								(e =
									null == e ? 0 : e < 0 ? Math.max(r + e, 0) : Math.min(e, r)),
									(n =
										null == n
											? r
											: n < 0
						...
						function (t, e, n) {
							...
							var l = u(n(10)),
								...
								b = o(n(22)),
								y = o(n(49)),
								w = { id: 1, name: "top", origin: location.origin };
												...
												console[e] = function () {
													...
													n.apply(void 0, e),
														(e = h.default(e, function (t) {
															return b.wrap(t, { generatePreview: !0 });
														})),
								...
								(e.evaluate = function (t) {
									...
									try {
										...
										(n.exceptionDetails = {
											...
											(n.result = b.wrap(t, { generatePreview: !0 }));
									}
									return n;
								}),
											...
											switch (i.label) {
												case 0:
													return (
														...
														(a = _.default(o)),
														"}" !== o[o.length - 1]
															? a.push("return " + o.slice(o.indexOf("=>") + 2))
															: a.push(
																	o.slice(
																		o.indexOf("{") + 1,
																		o.lastIndexOf("}")
								...
								return (
									f.default(n)
										? ((e = n.split("\n")),
										  ...
										  e.shift(),
										  (e = h.default(e, function (t) {
												return { functionName: m.default(t) };
										  })))
										: (n.shift(),
							...
							(e = function (t) {
								for (
									...
									if (e.regex)
										...
										"'" === t[n] && "\\" !== t[n - 1] && (e.singleQuote = !1);
									else if (e.doubleQuote)
										'"' === t[n] && "\\" !== t[n - 1] && (e.doubleQuote = !1);
									else if (e.blockComment)
										"*" === t[n] &&
											"/" === t[n + 1] &&
											((t[n + 1] = ""), (e.blockComment = !1)),
											(t[n] = "");
						...
						function (t, e) {
							...
							(e = function (t, e) {
								...
								for (
									var r, i, o = 0, a = t.length, s = e.length, u = !0;
									u && o < a;
						...
						function (t, e) {
							...
							(e = function (t, e) {
								if (null == e) return t.replace(n, "");
								for (
									var r, i, o = t.length - 1, a = e.length, s = !0;
									s && o >= 0;
							...
							function u(t, e) {
								...
								if (s.nodeType)
									for (; s !== this; s = s.parentNode || this) {
										for (r = [], a = 0; a < l; a++)
											void 0 === r[(n = (o = e[a]).selector + " ")] &&
												(r[n] = i(this.querySelectorAll(n), s)),
												r[n] && r.push(o);
										r.length && u.push({ el: s, handlers: r });
									}
								return (
									l < e.length && u.push({ el: this, handlers: e.slice(l) }), u
								);
							}
							(e = {
						...
						function (t, e, n) {
							...
							(e = function (t, e, n) {
								e = r(e, n);
								for (
									var a = !i(t) && o(t), s = (a || t).length, u = 0;
									u < s;
									u++
								) {
									var l = a ? a[u] : u;
								...
								},
								{
									parse: function (t) {
										...
										if (
											...
											var p = s.lastIndexOf("@");
											-1 !== p &&
												((e.auth = decodeURIComponent(s.slice(0, p))),
												(s = s.slice(p + 1))),
												(e.hostname = s);
											var v = s.match(_);
											v &&
												(":" !== (v = v[0]) && (e.port = v.substr(1)),
												(e.hostname = s.substr(0, s.length - v.length)));
										}
										var g = n.indexOf("#");
									...
									stringify: function (t) {
										var e =
											...
											t.pathname;
										return (
											s(t.query) || (e += "?" + a.stringify(t.query)),
											t.hash && (e += t.hash),
											e
										);
									},
										...
										r(t, {
											...
											comment: function (t) {
												var r = "\x3c!--".concat(t, "--\x3e"),
													i = n.peek();
												i
													? (i.content || (i.content = []), i.content.push(r))
													: e.push(r);
											},
											text: function (t) {
												var r = n.peek();
								...
								for (var n, i = [], p = t; t; ) {
									if (((n = !0), r(i) && h[r(i)])) {
										...
										if (f) {
											...
											(t = t.substring(f.index + f[0].length)),
												_ && e.text && e.text(_);
										}
										x(0, r(i));
									} else {
										if (o(t, "\x3c!--")) {
											var d = t.indexOf("--\x3e");
											d >= 0 &&
												(e.comment && e.comment(t.substring(4, d)),
												(t = t.substring(d + 3)),
												(n = !1));
										} else if (o(t, "<!")) {
											var v = t.match(s);
											v &&
												(e.text && e.text(t.substring(0, v[0].length)),
						...
						function (t, e, n) {
							...
							Object.defineProperty(e, "__esModule", { value: !0 }),
								(e.setStyleTexts =
									e.getStyleSheetText =
									e.getBackgroundColors =
									e.getMatchedStylesForNode =
									e.getInlineStylesForNode =
									e.getComputedStyleForNode =
									e.enable =
										void 0);
							var u = n(26),
								l = a(n(131)),
							...
							function m(t) {
								var e,
									...
									o = u.getNode(i),
									a = o.style,
									s = { shorthandEntries: [], cssProperties: [] };
								if (a) {
									...
									m = c.default(m, function (t) {
										var e = t.name,
											...
											i = r.text,
											o = { name: e, value: n, text: i, range: r.range };
										return (
											_.default(i, "/*")
												? (o.disabled = !0)
												: ((o.disabled = !1),
						...
						function (t, e, n) {
							...
							Object.defineProperty(e, "__esModule", { value: !0 }),
								(e.getInlineStyleNodeId =
									e.getInlineStyleSheetId =
									e.getOrCreateInlineStyleSheetId =
									e.formatStyle =
									e.getMatchedCssRules =
									e.getStyleSheets =
									e.onStyleSheetAdded =
									e.matchesSelector =
										void 0);
						...
						function (t, e, n) {
							...
							Object.defineProperty(e, "__esModule", { value: !0 }),
								(e.enable =
									e.setDOMStorageItem =
									e.removeDOMStorageItem =
									e.getDOMStorageItems =
									e.clear =
										void 0);
							var i = r(n(63)),
								o = r(n(0)),
						...
						function (t, e, n) {
							...
							e = {
								encode: function (t) {
									for (
										var e = r.decode(t), n = "", i = 0, o = e.length;
										i < o;
										i++
									)
										n += f(e[i]);
						...
						function (t, e, n) {
							...
							function y(t) {
								...
								if (
									...
									return (
										x.detach(),
										N.css({ left: O, top: j, width: $, height: S }).show(),
								...
								if (1 === e.nodeType) {
									var E = c.default(e).offset(),
										...
										C = E.top,
										P = E.height;
									N.css({ left: A, top: C, width: T, height: P }).show();
											...
											? q
													...
													.html(
														(function (t) {
															...
															return (
																_.default(n) &&
																	d.default(n.split(/\s+/g), function (t) {
																		"" !== v.default(t) && (i += "." + t);
																	}),
																r +
																	'<span style="color:1a1aa8;">' +
							...
							(e.setInspectMode = function (t) {
								...
								p.default()
									? (E("touchstart", j), E("touchmove", j), E("touchend", S))
									: (E("mousemove", j),
									  E("mouseout", function () {
											"none" !== O && w();
									  }),
								...
								return (
									...
									u(e, function (t, e) {
										i(t)
											? g.setAttribute(e, t)
											: l(t) && o(e, "on")
											? g.addEventListener(e.slice(2), t, !1)
											: "style" === e && s(g, t);
									}),
									g
								);
						...
						function (t, e, n) {
							...
							var v =
									s.default(window, "EventTarget.prototype") ||
							...
							function b(t, e, n, r) {
								if ((void 0 === r && (r = !1), u.default(t) && l.default(n))) {
									c.default(r) && (r = { capture: r }),
										f.default(r, { capture: !1, passive: !1, once: !1 });
								...
								if (u.default(t) && l.default(n)) {
									...
									if (r && r[e]) {
										...
										0 === i.length && delete r[e],
											0 === h.default(r).length && delete t.chiiEvents;
									}
								}
							}
				...
				(t.exports = (function (t) {
					...
					function (t, e, n) {
						...
						e.sortObjName = function (t, e) {
							...
							(s.default(t, "get ") || s.default(t, "set ")) &&
								(t = t.slice(4)),
								(s.default(e, "get ") || s.default(e, "set ")) &&
									(e = e.slice(4));
							for (
								var o = t.length, u = e.length, l = o > u ? u : o, h = 0;
								h < l;
								h++
							) {
							...
							(((i = (function (t) {
								function e(e, n) {
									...
									return (
										...
										u.$container.addClass("luna-object-viewer"),
										(u.unenumerable = o),
										(u.accessGetter = s),
										u.bindEvent(),
										u
									...
									(e.prototype.objToHtml = function (t, e) {
										...
										if (
											(this.unenumerable &&
												...
												l.push("symbol"),
												(h = w.default(
													x.default(t, { prototype: !1, unenumerable: !0 }),
													c
												)),
												(p = k.default(
													x.default(t, { prototype: !1, symbol: !0 }),
													function (t) {
														return "symbol" == typeof t;
													}
												))),
										...
										v.default(l, function (r) {
											...
											for (var u = 0, l = a.length; u < l; u++) {
												var f = $.default(a[u]),
													...
													b = v && v.get,
													y = v && v.set;
												if (b && !n.accessGetter) d = "(...)";
												else
													try {
														(d = "virtual" === r ? g[f] : i[f]),
															m.default(d) && d.catch(j.default);
													} catch (t) {
														d = t.message;
													}
												(s += n.createEl(f, t, d, r, e)),
													b && (s += n.createEl("get " + f, t, v.get, r, e)),
													y && (s += n.createEl("set " + f, t, v.set, r, e));
											}
										});
										var S = u.default(t);
										if (!e && S)
											if ("" === s) {
												...
												s += this.createEl("__proto__", i || t, S, "proto");
										return s;
									}),
									(e.prototype.createEl = function (t, e, n, r, i) {
										...
										if (p.default(n)) {
											...
											var v =
												...
												m =
													"<li " +
													(i ? 'data-first-level="true"' : "") +
													' data-object-id="' +
													f +
													'"><span class="' +
													(i ? "" : T + "expanded " + T + "collapsed") +
													'"></span>' +
													y(t) +
													'<span class="' +
													T +
											...
											return (
												...
												m + '</ul><span class="' + T + 'close"></span></li>'
											);
										}
										function y(t) {
											if (i) return "";
									...
									(e.prototype.bindEvent = function () {
										...
										this.$container.on("click", "li", function (e) {
											...
											if (
												!r.data("first-level") &&
												(i &&
													(r.find("ul").html(t.objToHtml(n[i], !1)),
												...
												o.hasClass(T + "collapsed")
													? (o.rmClass(T + "collapsed"), a.show())
													: (o.addClass(T + "collapsed"), a.hide()),
													t.emit("change");
											}
										});
									}),
					...
					function (t, e, n) {
						...
						(e = function (t, e, n) {
							e = r(e, n);
							for (
								var a = !o(t) && i(t), s = (a || t).length, u = Array(s), l = 0;
								l < s;
								l++
							) {
								var c = a ? a[l] : l;
					...
					function (t, e, n) {
						...
						(e = r(function (t, e) {
							return function () {
								var n = [];
								return (
									(n = (n = n.concat(e)).concat(i(arguments))), t.apply(this, n)
								);
							};
						})),
							(t.exports = e);
					...
					function (t, e, n) {
						...
						e = function (t, e, n) {
							if (((t = l(t)), a(n) && r(e)))
								return (function (t, e) {
									return (
										t.style[c(e)] || getComputedStyle(t, "").getPropertyValue(e)
									);
								})(t[0], e);
							var f = e;
							i(f) || ((f = {})[e] = n),
							...
							k = (function (t) {
								function e(e) {
									...
									return (
										...
										n.$container.addClass("luna-object-viewer"),
										n.bindEvent(),
										n
									);
								}
													...
													if (
														...
														var i = (function (t, e, n) {
															var r = [],
																i = {};
															return (
																f.default(t.enumerable, function (t, e) {
																	var n = h.default(e);
									...
									(e.prototype.createEl = function (t, e, n, r) {
										...
										if (u.default(e)) {
											var o = e.id,
												...
												l =
													"<li " +
													(r ? 'data-first-level="true"' : "") +
													' data-object-id="' +
													(a || o) +
													'"><span class="' +
													(r ? "" : x + "expanded " + x + "collapsed") +
													'"></span>' +
													h(t) +
													'<span class="' +
													x +
													...
													">";
											return (
												r && (l += this.objToHtml(this.map[o])),
												l + '</ul><span class="' + x + 'close"></span></li>'
											);
										}
										function h(t) {
											if (r) return "";
										...
										this.$container.on("click", "li", function (e) {
											...
											if (
												...
												o.hasClass(x + "collapsed")
													? (o.rmClass(x + "collapsed"), s.show())
													: (o.addClass(x + "collapsed"), s.hide()),
													t.emit("change");
											}
										});
									}),
					...
					(S.prototype.allow_wrap_or_preserved_newline = function (t, e) {
							...
							if (h(this._flags.last_token.text, l) || h(t.text, l)) {
								var r =
									(h(this._flags.last_token.text, l) &&
										h(this._options.operator_position, v)) ||
									h(t.text, l);
								n = n && r;
							}
						...
						(S.prototype.handle_end_block = function (t) {
							...
							this._flags.inline_frame && !e
								...
								: e ||
								  ($(this._flags.mode) && this._options.keep_array_indentation
						...
						(S.prototype.handle_word = function (t) {
							if (
								(t.type === c.RESERVED &&
									((h(t.text, ["set", "get"]) && this._flags.mode !== b) ||
										("import" === t.text && "(" === this._tokens.peek().text) ||
										(h(t.text, ["as", "from"]) && !this._flags.import_block) ||
										(this._flags.mode === b &&
							...
							if (
								...
								return (
									...
									this._flags.last_token.type === c.WORD
										...
										? (this._output.space_before_token = !0)
										: (this._flags.multiline_frame ||
												(!j(this._flags.mode) && !$(this._flags.mode))) &&
										  this.print_newline(),
									this.print_token(t),
									...
									? (j(this._flags.parent.mode) &&
									  ...
									  this._flags.declaration_assignment
											...
											: this._options.comma_first &&
											  this.allow_wrap_or_preserved_newline(t))
									: this._flags.mode === b ||
									  (this._flags.mode === m && this._flags.parent.mode === b)
							...
							if ("*" !== t.text || this._flags.last_token.type !== c.DOT)
								if ("::" !== t.text) {
									...
									if (
										...
										!n && !e && this._options.preserve_newlines && h(t.text, l))
									) {
										var s = ":" === t.text,
											p = s && a,
											b = s && !a;
										switch (this._options.operator_position) {
											case d.before_newline:
												return (
													...
													this.print_token(t),
													(s && !p) || this.allow_wrap_or_preserved_newline(t),
											...
											case d.preserve_newline:
												return (
													b || this.allow_wrap_or_preserved_newline(t),
									...
									if (e) {
										...
										"..." === t.text
											? (this.allow_wrap_or_preserved_newline(t),
											  (i = this._flags.last_token.type === c.START_BLOCK),
											  (o = !1))
											: (h(t.text, ["--", "++", "!", "~"]) || n) &&
											  ((this._flags.last_token.type !== c.COMMA &&
													this._flags.last_token.type !== c.START_EXPR) ||
							...
							if (
								...
								for (
									...
									i
										...
										: a && r[n]
										? (this.print_token_line_indentation(t),
										  this._output.add_token(r[n].substring(u)))
										: (this._output.current_line.set_indent(-1),
											...
											(n =
												(n =
													(n =
														...
														this._read_comment(r)) ||
													this._read_regexp(r, t)) || this._read_xml(r, t)) ||
						...
						(k.prototype._read_non_javascript = function (t) {
							...
							if ("#" === t) {
								...
								if ((e = this.__patterns.html_comment_start.read())) {
									for (
										;
										this._input.hasNext() && !this._input.testChar(s.newline);
								...
								if (r) {
									for (
										...
										var u = !!r[1],
											l = r[2];
										if (
											(!(r[r.length - 1] || "![CDATA[" === l.slice(0, 8)) &&
												(l === i ||
													(o &&
						...
						(i.prototype.__split = function (t, e) {
							...
							for (var n = 0, r = [], i = t.exec(e); i; )
								r.push(e.substring(n, i.index)),
									...
									(i = t.exec(e));
							return (
								n < e.length ? r.push(e.substring(n, e.length)) : r.push(""), r
							);
						}),
									...
									if ((this.preserveSingleSpace(r), "{" === this._input.peek()))
										...
										k.match(/[ :]$/) &&
											...
											k in this.NESTED_AT_RULE
												? ((this._nestedLevel += 1),
												  k in this.CONDITIONAL_GROUP_RULE && (g = !0))
												: d ||
												  0 !== _ ||
												  -1 === k.indexOf(":") ||
												  ((v = !0), this.indent());
									...
									"#" === this._ch && "{" === this._input.peek()
										...
										? this._input.lookBack("url")
											...
											: (this.preserveSingleSpace(r),
											  ...
											  this.indent())
										: ")" === this._ch
										? (_ && (_--, this.outdent()), this.print_string(this._ch))
										: "," === this._ch
										? (this.print_string(this._ch),
										  this.eatWhitespace(!0),
			...
			window,
				(t.exports = (function (t) {
					...
					function (t, e, n) {
						...
						Object.defineProperty(e, "__esModule", { value: !0 }), n(25);
						var o,
							a,
							s = i(n(26)),
							u = i(n(59)),
								...
								return (
									...
									(t.prototype.appendTpl = function () {
										...
										"top" === i && (a = "flex-start"),
											...
											(this.$notification = t.find(".luna-notification"));
									}),
									t
								);
							})(),
							p = (function () {
								function t(t, e) {
									(this.container = t),
										(this.content = e),
										(this.id = l.default("luna-notification-"));
								}
								return (
						...
						typeof (r = function () {
							...
							function s(e) {
								if (
									...
									for (
										var c = (l.isBorderBox = "border-box" == u.boxSizing),
											h = 0;
										h < r;
										h++
									) {
					...
					t.registerHelper("each", function (t, e) {
						...
						if (
							...
							if (o.isArray(t))
								...
								for (
									var _ = [], d = t[r.Symbol.iterator](), v = d.next();
									!v.done;
									v = d.next()
								)
									_.push(v.value);
				...
				(e.template = function (t, e) {
					...
					var r = {
						...
						invokePartial: function (n, r, o) {
							o.hash &&
								((r = i.extend({}, r, o.hash)), o.ids && (o.ids[0] = !0)),
						...
						program: function (t, e, n, r, i) {
							...
							return (
								e || i || r || n
									...
									: o || (o = this.programs[t] = h(this, t, a)),
								o
							);
						},
						data: function (t, e) {
						...
						(o._setup = function (o) {
							if (o.partial)
								...
								!(function (t, e) {
									...
									(r.helpers = a),
									t.usePartial &&
										(r.partials = r.mergeIfNeeded(o.partials, e.partials)),
									(t.usePartial || t.useDecorators) &&
										(r.decorators = i.extend({}, e.decorators, o.decorators)),
									(r.hooks = {}),
						...
						(_.prototype.beautify = function () {
							...
							for (var p = null, _ = h.next(); _.type !== a.EOF; )
								_.type === a.TAG_OPEN || _.type === a.COMMENT
									? (i = p = this._handle_tag_open(c, _, i, r))
									: _.type === a.ATTRIBUTE ||
									  _.type === a.EQUALS ||
									  _.type === a.VALUE ||
							...
							if (
								...
								if (
									...
									e.type === a.ATTRIBUTE &&
										...
										((this._is_wrap_attributes_preserve ||
											this._is_wrap_attributes_preserve_aligned) &&
											(t.traverse_whitespace(e), (i = i || 0 !== e.newlines)),
										this._is_wrap_attributes_force))
								) {
						...
						if (!t.is_empty_element && t.is_start_tag && t.parent) {
							if ("body" === t.tag_name)
								...
								"rp" === t.tag_name || "rt" === t.tag_name
									? (e =
											(e =
												e || this._tag_stack.try_pop("rt", ["ruby", "rtc"])) ||
				...
				function (t, e, n) {
					...
					((c.prototype = new r())._is_comment = function (t) {
												...
												(n =
													(n =
														(n =
															(n =
																(n =
																	(n = n || this._read_open_handlebars(r, e)) ||
																	this._read_attribute(r, t, e)) ||
																this._read_raw_content(r, t, e)) ||
															this._read_close(r, e)) ||
														this._read_content_word(r)) ||
													this._read_comment_or_cdata(r)) ||
												this._read_processing(r)) || this._read_open(r, e)) ||
						...
						(c.prototype._read_comment_or_cdata = function (t) {
							...
							return (
								"<" === t &&
									...
									n && ((e = this._create_token(u.COMMENT, n)).directives = r)),
								e
							);
						}),
						(c.prototype._read_processing = function (t) {
							...
							if ("<" === t) {
								...
								("!" !== r && "?" !== r) ||
									...
									n &&
										((e = this._create_token(u.COMMENT, n)).directives = null);
							}
							return e;
						}),
							...
							return (
								e ||
									("<" === t &&
										...
										(r = this._create_token(u.TAG_OPEN, n)))),
								r
							);
						}),
									...
									(this._options.indent_handlebars &&
										...
										("!" === this._input.peek(2)
											? ((n =
													...
													this.__patterns.handlebars.read()),
											  (r = this._create_token(u.COMMENT, n)))
								...
								e &&
									...
									(">" === t || ("/" === t && ">" === this._input.peek(1)))
										? ((n = this._input.next()),
										  ...
										  (r = this._create_token(u.TAG_CLOSE, n)))
										: "{" === e.text[0] &&
										  "}" === t &&
										  "}" === this._input.peek(1) &&
										  (this._input.next(),
										  this._input.next(),
										  (r = this._create_token(u.TAG_CLOSE, "}}")))),
								r
							);
						}),
						(c.prototype._read_attribute = function (t, e, n) {
							...
							if (n && "<" === n.text[0])
								if ("=" === t)
									r = this._create_token(u.EQUALS, this._input.next());
								else if ('"' === t || "'" === t) {
									...
									(i = this.__patterns.attribute.read()) &&
										(r =
											e.type === u.EQUALS
												...
												: this._create_token(u.ATTRIBUTE, i));
							return r;
						}),
			...
			t.exports = (r.default || r).template({
				...
				11: function (t, e, n, r, i) {
					...
					return (
						...
						(null != (o = a(null != e ? s(e, "value") : e, e)) ? o : "") +
						"</td></tr> "
					);
				},
				...
				24: function (t, e, n, r, i) {
					...
					return (
						...
						"> " +
						t.escapeExpression(
							t.lambda(null != e ? a(e, "computedStyleSearchKeyword") : e, e)
						) +
						" </div> "
					);
				},
			...
			t.exports = (r.default || r).template({
				1: function (t, e, n, r, i) {
					...
					return (
						...
						">" +
						t.escapeExpression(
							t.lambda(null != e ? a(e, "localStoreSearchKeyword") : e, e)
						) +
						"</div>"
					);
				},
				...
				8: function (t, e, n, r, i) {
					...
					return (
						...
						">" +
						t.escapeExpression(
							t.lambda(null != e ? a(e, "sessionStoreSearchKeyword") : e, e)
						) +
						"</div>"
					);
				},
				...
				13: function (t, e, n, r, i) {
					...
					return (
						...
						">" +
						t.escapeExpression(
							t.lambda(null != e ? a(e, "cookieSearchKeyword") : e, e)
						) +
						"</div>"
					);
				},
		...
		function (t, e, n) {
			...
			t.exports = (r.default || r).template({
				...
				main: function (t, e, n, r, i) {
					...
					return (
						'<iframe src="' +
						(null != (o = t.lambda(null != e ? a(e, "src") : e, e)) ? o : "") +
						'"></iframe>'
					);
				},
				useData: !0,
		...
		function (t, e, n) {
			...
			function D(t) {
				...
				Object(d.t)(r, function (t) {
					e = e.replace(
						new RegExp("var\\(--".concat(Object(d.U)(t), "\\)"), "g"),
						C[t]
					);
				}),
					(n.innerText = e);
							...
							[
								{
									key: "init",
									value: function (t) {
										b()(p()(o.prototype), "init", this).call(this, t),
											this._bindEvent();
									},
								},
								{
								...
								},
								{
									key: "destroy",
									value: function () {
										b()(p()(o.prototype), "destroy", this).call(this),
								...
								},
								{
									...
									value: function (t, e, n) {
										...
										return (
											this._settings.push({ config: t, key: e, id: r }),
											this._$el.append(
												this._switchTpl({
													desc: n,
													key: e,
								...
								},
								{
									...
									value: function (t, e, n) {
										...
										return (
											this._settings.push({ config: t, key: e, id: i }),
											this._$el.append(
												this._colorTpl({
													desc: n,
													colors: r,
								...
								},
								{
									...
									value: function (t) {
										return (
											this._$el.append(
												'<div class="eruda-text">'.concat(t, "</div>")
											),
											this
										);
									},
								...
								},
								{
									...
									value: function (t) {
										var e;
										return (
											Object(d.t)(this._settings, function (n) {
												n.id === t && (e = n);
											}),
											e
										);
					...
					a()(o, [
						...
						},
						{
							...
							value: function (t) {
								...
								t
									.separator()
									.switch(e, "rememberPos", "Remember Entry Button Position"),
									this._resetPos();
							},
						},
						{
							...
							value: function () {
								...
								return { x: window.innerWidth - t, y: window.innerHeight - t };
							},
						},
					]),
					o
						...
						a()(o, [
								...
								value: function (t) {
									if (!(t instanceof y)) {
										var e = new y(),
											...
											i = e.hide,
											o = e.destroy;
										Object(d.q)(t, { init: n, show: r, hide: i, destroy: o });
									}
									var a = t.name;
									return a
										? ((a = a.toLowerCase()),
										  this._tools[a]
												? U.warn("Tool ".concat(a, " already exists"))
												: (this._$tools.prepend(
														'<div id="eruda-'
															.concat(a, '" class="eruda-')
															.concat(a, ' eruda-tool"></div>')
												  ),
												  t.init(
														this._$tools.find(
															".eruda-".concat(a, ".eruda-tool")
														),
														this
												  ),
												  (t.active = !1),
												  ...
												  this._navBar.add(a),
												  this))
										: U.error("You must specify a name for a tool");
								},
							},
							{
								key: "remove",
							...
							},
							{
								...
								value: function (t) {
									...
									this._setTransparency(n.get("transparency")),
										...
										t
											.separator()
											.select(n, "theme", "Theme", Object(d.V)(R.getThemes()))
							...
							},
							{
								...
								value: function (t) {
									Object(d.O)(t) &&
										((this._opacity = t),
										this._isShow && this._$el.css({ opacity: t }));
								},
							},
							{
								key: "_setDisplaySize",
								value: function (t) {
									Object(d.O)(t) && this._$el.css({ height: t + "%" });
								},
							},
							{
								key: "_appendTpl",
							...
							},
							{
								...
								value: function () {
									var t = this;
									(this._navBar = new q(
										this._$el.find(".eruda-nav-bar-container")
									)),
							...
							},
							{
								...
								value: function () {
									var t = this,
										...
										i = function (e) {
											...
											e.preventDefault(),
												...
												(e = e.origEvent);
											var n = Math.round(
													((t._resizeStartY - a(e)) / window.innerHeight) * 100
												),
									...
									Object(d.L)()
										? (e.on("touchstart", n).on("touchmove", i),
										  s.on("touchend", o))
										: (e.on("mousedown", n),
										  s.on("mousemove", i),
										  s.on("mouseup", o));
					...
					a()(r, [
						...
						},
						{
							...
							value: function (t) {
								...
								return (
									this.time && (e.find("span").eq(0).text(t), (this.time = t)),
									this
								);
							},
						},
						...
						},
						{
							...
							value: function () {
								...
								$t(
									"table" === r || (1 === n.length && Object(d.P)(n[0]))
										? n[0]
										: n,
									{},
									i
						...
						},
						{
							...
							value: function () {
								var t = this.args,
									...
									o = this.group;
								(t = Object(d.j)(t)),
									this._needSrc() && !r.lazyEvaluation && this.extractObj();
								var a,
									s,
									u = "";
								switch (
									(("group" !== e && "groupCollapsed" !== e) ||
									...
									case "warn":
										...
										break;
									case "error":
										Object(d.S)(t[0]) && 1 !== t.length && (t = mt(t)),
											(s = t[0]),
											(a = "error"),
											(s = Object(d.I)(s) ? s : new Error(vt(t))),
											(this.src = s),
											(u = (function (t) {
									...
									case "table":
										u = (function (t) {
											...
											Object(d.t)(e, function (t) {
												Object(d.Q)(t)
													? i.push(ht)
													: Object(d.P)(t) && (i = i.concat(Object(d.V)(t)));
											}),
											...
											return Object(d.H)(i)
												...
												: ((n += "<table><thead><tr><th>(index)</th>"),
												  i.forEach(function (t) {
														return (n += "<th>".concat(
															t === ht ? "Value" : Object(d.ub)(t),
															"</th>"
														));
												  }),
												  (n += "</tr></thead><tbody>"),
												  Object(d.t)(e, function (t, e) {
														(n += "<tr><td>".concat(e, "</td>")),
								...
								(this._needSrc() && r.lazyEvaluation) || delete this.args,
									"error" === e ||
										this.args ||
			...
			var ct = Object(d.Bb)(
					function t(e) {
							...
							if (h > _) m = ", …";
								...
								if (!u)
									if (Object.getOwnPropertyDescriptor(e, n).get)
										return (
											v.push("".concat(r, ": ").concat(M("(...)"))), void h++
										);
						...
						if (b) p = M("[circular]");
							...
							rt(e) && (e = Object.getPrototypeOf(e)),
								(g = c ? Object.getOwnPropertyNames(e) : Object.keys(e)),
								w
									? ((h = 1),
									  (p = "{ "),
									  Object(d.t)(g, I),
									  (p += v.join(", ") + m + " }"))
									: "Object" === (p = Object(d.B)(e)) && (p = "{…}");
						else if (B)
							(p = e + ""),
								(p =
					...
					function (t, e) {
						return (
							...
							t(e, { getterVal: lt.showGetterVal, unenumerable: !1 }) +
							"</span>"
						);
					}
				),
			...
			function yt(t) {
				var e = Object(d.B)(t);
				return (
					"Array" === e && t.length > 1 && (e = "(".concat(t.length, ")")),
			...
			function xt(t) {
				return '<pre style="display:inline">'.concat(
					Object(d.C)(
						ot.a.html(t.outerHTML, { unformatted: [], indent_size: 2 }),
						"html"
					),
					"</pre>"
				);
				...
				Ct = (function (t) {
					...
					function o(t) {
						...
						return (
							...
							(e._global = {
								copy: function (t) {
									Object(d.S)(t) || (t = JSON.stringify(t, null, 2)),
										Object(d.n)(t);
								},
								$: function () {
					...
					return (
						a()(o, [
							...
							},
							{
								...
								value: function (t) {
									...
									(this._maxNum = t),
										Object(d.O)(t) &&
											e.length > t &&
											((this._logs = e.slice(e.length - t)), this.render());
								},
							},
							{
							...
							},
							{
								...
								value: function (t) {
									return (
										(this._filter = t), this.emit("filter", t), this.render()
									);
								},
							},
							{
							...
							},
							{
								...
								value: function () {
									...
									if (!Object(d.H)(e)) {
										...
										return r
											? void 0
											: (0 === e.length && e.unshift("console.assert"),
							...
							},
							{
								...
								value: function () {
									...
									return this._timer[t]
										? this.insert("warn", [
												"Timer '".concat(t, "' already exists"),
										  ])
										: ((this._timer[t] = Object(d.gb)()), this);
								},
							},
							{
								key: "timeLog",
								value: function () {
									...
									return e
										? this.info(
												"".concat(t, ": ").concat(Object(d.gb)() - e, "ms")
										  )
										: this.insert("warn", [
							...
							},
							{
								...
								value: function (t, e) {
									var n;
									this._displayHeader && (n = { time: Pt(), from: Nt() }),
										this._asyncRender
							...
							},
							{
								...
								value: function (t, e, n) {
									...
									if ("groupEnd" === t)
										return (
											this._lastLog.groupEnd(), this._groupStack.pop(), this
										);
									var a = Object(d.S)(t) ? { type: t, args: e } : t;
									if (
									...
									var l = this._lastLog;
									if (
										(Object(d.m)(["html", "group", "groupCollapsed"], u.type) ||
										l.type !== u.type ||
										u.src ||
										u.args ||
										l.text() !== u.text()
							...
							},
							{
								...
								value: function (t) {
									if (this._filterLog(t) && !t.collapsed) {
										var e = this._displayLogs;
										if (0 === e.length)
											return e.push(t), void this.renderViewport();
										var n = Object(d.W)(e);
										if (t.id > n.id)
											return e.push(t), void this.renderViewport();
										for (var r, i, o = 0, a = e.length - 1; o <= a; ) {
											if (
												(r = e[(i = o + Math.floor((a - o) / 2))]).id === t.id
											)
												return;
											r.id < t.id ? (o = i + 1) : (a = i - 1);
										}
										r.id < t.id ? e.splice(i + 1, 0, t) : e.splice(i, 0, t),
											this.renderViewport();
									}
								},
							},
							...
							},
							{
								...
								value: function (t) {
									for (
										var e, n = this._logs, r = 0, i = n.length;
										r < i && (e = n[r]).id !== t;
										r++
									);
									return e;
									...
									this._$el
										...
										this._$container.on("scroll", function () {
											...
											if (!(i <= 0 || r + i > n)) {
												...
												l > 1e3 && (h = 1e3),
													h > t._maxSpeedTolerance &&
														(h = t._maxSpeedTolerance),
													h < t._minSpeedTolerance &&
														(h = t._minSpeedTolerance),
													(t._lastScrollTop = i),
													(t._lastTimestamp = u);
												var p = 0,
													f = 0;
												a < i
													? ((p = t._minSpeedTolerance), (f = h))
													: ((p = h), (f = t._minSpeedTolerance)),
													(t._topSpaceHeight < i - p &&
														t._topSpaceHeight + t._el.offsetHeight >
															i + r + f) ||
														t.renderViewport({
															topTolerance: 2 * p,
															bottomTolerance: 2 * f,
						...
						a()(o, [
							...
							},
							{
								...
								value: function (t) {
									...
									t
										? (r.show(), n.rmClass("eruda-js-input-hidden"))
										: (r.hide(), n.addClass("eruda-js-input-hidden"));
								},
							},
							{
								key: "_registerListener",
									...
									["filter", "html"].concat(Mt).forEach(function (n) {
										return (t[n] = function () {
											for (
												...
												i[o] = arguments[o];
											return (
												e[n].apply(e, i), t.emit.apply(t, [n].concat(i)), t
											);
										});
									});
								},
									...
									i
										...
										.on("click", ".eruda-search", function () {
											...
											Object(d.N)(e) ||
												...
												"" !== Object(d.vb)(e)
													? t._logger.filter(
															new RegExp(Object(d.x)(Object(d.Z)(e)))
													  )
													: a.filter("all"));
										}),
										r
											...
											.on("click", ".eruda-execute", function () {
												var e = n.val().trim();
												"" !== e &&
													(a.input(e), n.val("").get(0).blur(), t._hideInput());
											}),
								...
								value: function () {
									...
									o &&
										o
											...
											.switch(r, "asyncRender", "Asynchronous Rendering")
											.switch(r, "jsExecution", "Enable JavaScript Execution")
											.switch(r, "catchGlobalErr", "Catch Global Errors")
											.switch(r, "overrideConsole", "Override Console")
											.switch(r, "displayIfErr", "Auto Display If Error Occurs")
											.switch(
												r,
												"displayExtraInfo",
											...
											.switch(r, "displayGetterVal", "Access Getter Value")
						...
						Y()(J()(t), "_loadingFinished", function (e) {
							...
							if (n) {
								...
								(n.time = r - n.startTime),
									...
									(n.resTxt = Lt.a
										.domain("Network")
										.getResponseBody({ requestId: e.requestId }).body),
									t._render();
							}
						}),
						(t._style = R(n(75))),
					...
					a()(o, [
						...
						},
						{
							...
							value: function (t) {
								var e = (function (t) {
										if (!t) return "unknown";
										var e = t.split(";")[0].split("/");
										return { type: e[0], subType: Object(d.W)(e) };
						...
						},
						{
							...
							value: function () {
								...
								o.on("requestWillBeSent", this._reqWillBeSent),
									o.on("responseReceivedExtraInfo", this._resReceivedExtraInfo),
									o.on("responseReceived", this._resReceived),
									o.on("loadingFinished", this._loadingFinished);
							},
						},
						{
							key: "destroy",
							value: function () {
								...
								t.off("requestWillBeSent", this._reqWillBeSent),
									...
									t.off("responseReceived", this._resReceived),
									t.off("loadingFinished", this._loadingFinished);
							},
						},
						{
							key: "_showDetail",
							value: function (t) {
								t.resTxt && "" === Object(d.vb)(t.resTxt) && delete t.resTxt,
									Object(d.H)(t.resHeaders) && delete t.resHeaders,
									Object(d.H)(t.reqHeaders) && delete t.reqHeaders,
						...
						},
						{
							...
							value: function () {
								if (this.active) {
									var t = {};
									Object(d.H)(this._requests) || (t.requests = this._requests),
						...
						},
						{
							...
							value: function (t) {
								t !== this._lastHtml &&
									((this._lastHtml = t), this._$requests.html(t));
							},
						},
					]),
					o
				...
				return (function (t) {
					return Object(d.nb)(t, {
						comparator: function (t, e) {
							for (
								var n = t.length, r = e.length, i = n > r ? r : n, o = 0;
								o < i;
								o++
							) {
						...
						},
						{
							...
							value: function () {
								var t = this,
									e = [];
								return (
									Object(d.t)(document.styleSheets, function (n) {
										try {
											if (!n.cssRules) return;
										} catch (t) {
											return;
											...
											""
												.concat(
													(function (t) {
														...
														var i = "";
														Object(d.S)(n) &&
															Object(d.t)(n.split(/\s+/g), function (t) {
					...
					a()(o, [
						{
							...
							value: function (t, e) {
								...
								b()(p()(o.prototype), "init", this).call(this, t),
									...
									(this._highlight = new Kt(this._container.$container)),
									(this._select = new Jt()),
									this._bindEvent(),
									this._initObserver(),
									this._initCfg(),
						...
						},
						{
							...
							value: function () {
								return (
									...
									b()(p()(o.prototype), "hide", this).call(this)
								);
							},
						},
						{
						...
						},
						{
							...
							value: function () {
								...
								(t.computedStyleSearchKeyword =
									...
									(t.parents = (function (t) {
										var e = [],
											...
											r = t.parentNode;
										for (; r && 1 === r.nodeType; )
											e.push({ text: ie(r, { noAttr: !0 }), idx: n++ }),
												(r = r.parentNode);
										return e.reverse();
									})(e)),
										...
										for (var e = [], n = 0, r = t.length; n < r; n++) {
											...
											if (3 !== o && 8 !== o) {
												...
												1 === o &&
													...
													e.push({ text: ie(i), isEl: !0, idx: n });
											} else {
												var s = i.nodeValue.trim();
												"" !== s && e.push({ text: s, isCmt: 8 === o, idx: n });
											}
										}
										return e;
									})(e.childNodes)),
								...
								var s = e.erudaEvents;
								if (
									(s && 0 !== Object(d.V)(s).length && (t.listeners = s), se(a))
								)
									return t;
								...
								var c = {
									...
									border: l("border"),
									padding: l("padding"),
									content: { width: pe(u.width), height: pe(u.height) },
								};
								...
								h.unshift(
									(function (t) {
										for (
											var e = { selectorText: "element.style", style: {} },
												n = 0,
												r = t.length;
											n < r;
											n++
						...
						},
						{
							...
							value: function (t) {
								t !== this._lastHtml &&
									((this._lastHtml = t), this._$showArea.html(t));
							},
						},
						{
							key: "_updateHistory",
						...
						},
						{
							...
							value: function () {
								...
								n &&
									...
									this._observer &&
										n.switch(e, "observeElement", "Auto Refresh"),
									n.separator());
							},
						},
					]),
			...
			function ie(t) {
				...
				if (
					("" !== i &&
						(s += '<span class="eruda-function-color">#'.concat(i, "</span>")),
					Object(d.S)(o))
				) {
					var u = "";
				...
				return (
					a()(o, [
						...
						},
						{
							...
							value: function (t, e, n) {
								return (
									this._snippets.push({ name: t, fn: e, desc: n }),
									this._render(),
									this
								);
							},
								...
								if (n) {
									...
									(n = JSON.parse(JSON.stringify(n))),
										Object(d.t)(n, function (t, n) {
											Object(d.S)(t) &&
												((e._hideErudaSetting &&
													(Object(d.ob)(n, "eruda") || "active-eruda" === n)) ||
													r.push({ key: n, val: $e(t, 200) }));
										}),
							...
							value: function () {
								...
								function o(t) {
									return function (e) {
										if (r.get("sources")) {
											...
											"iframe" !== t && Object(d.mb)(location.href, n)
												? Object(d.i)({
														url: n,
														success: function (e) {
															i(t, e);
								...
								n
									...
									.on("click", ".eruda-delete-cookie", function () {
										...
										Lt.a.domain("Network").deleteCookies({ name: t }),
											e.refreshCookie()._render();
									})
									.on("click", ".eruda-clear-storage", function () {
										"local" === Object(d.a)(this).data("type")
											? (Object(d.t)(e._localStoreData, function (t) {
													return localStorage.removeItem(t.key);
											  }),
											  e.refreshLocalStorage()._render())
											: (Object(d.t)(e._sessionStoreData, function (t) {
									...
									return (e = Object(d.Z)(e))
										? Object(d.z)(t, function (t) {
												var n = t.key,
													r = t.val;
												return (
													Object(d.m)(Object(d.Z)(n), e) ||
													Object(d.m)(Object(d.Z)(r), e)
												);
										  })
										: t;
								}
						...
						},
						{
							...
							value: function () {
								...
								Object(d.t)(this._infos, function (e) {
									var n = e.name,
										r = e.val;
									Object(d.J)(r) && (r = r()), t.push({ name: n, val: r });
								}),
						...
						a()(o, [
							...
							},
							{
								...
								value: function (t, e) {
									...
									return (
										(this._data = { type: t, val: e }), this._render(), this
									);
								},
							},
							{
								...
								value: function () {
									...
									e.get("showLineNum") || (this._showLineNum = !1),
										...
										this._container
											...
											.switch(e, "formatCode", "Beautify Code")
											.select(e, "indentSize", "Indent Size", ["2", "4"])
											.separator();
								},
							},
							{
							...
							},
							{
								...
								value: function () {
									...
									if (r < Re && this._formatCode) {
										switch (t.type) {
											case "html":
												n = ot.a.html(n, { unformatted: [], indent_size: e });
												break;
											case "css":
												n = ot.a.css(n, { indent_size: e });
												break;
											case "js":
			...
			e.default = {
				...
				add: function (t) {
					if (this._checkInit())
						return Object(d.J)(t) && (t = t(this)), this._devTools.add(t), this;
				},
				remove: function (t) {
				...
				_checkInit: function () {
					return (
						this._isInit || U.error('Please call "eruda.init()" first'),
						this._isInit
					);
				},
				_initContainer: function (t, e) {
					...
					t ||
						...
						"ios" === Object(d.r)().name && t.setAttribute("ontouchstart", ""),
				...
				_initStyle: function () {
					var t = this._$el;
					this._shadowRoot
						? ((R.container = this._shadowRoot), R(":host { all: initial }"))
						: (t.append(
								'<div class="'.concat("eruda-style-container", '"></div>')
						  ),
						  (R.container = t
				...
				_initTools: function () {
					...
					e.forEach(function (e) {
						...
						try {
							...
							Object(d.cb)(function () {
								U.error(
									"Something wrong when initializing tool ".concat(e, ":"),
									t.message
								);
							});
						}
